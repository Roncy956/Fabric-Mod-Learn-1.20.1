...
public class ModItems {
    ...
    public static final Item RAW_ICE_ETHER = register("raw_ice_ether", new Item(new Item.Settings()));
    public static final Item CARDBOARD = register("material/cardboard", new Item(new Item.Settings()));



    public static Item register(String id, Item item) {
        return register(new Identifier(LearnMod.MOD_ID, id), item);
    }
